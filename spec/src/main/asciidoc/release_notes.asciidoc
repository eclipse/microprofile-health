...
Items in bold are breaking changes.

- *Pruning `@Health` qualifier*
- *Fix `HealthCheckResponse` deserialization issue*
- Add configuration value for default readiness status
- Update dependencies scope and version to align on latest Jakarta EE 8 version

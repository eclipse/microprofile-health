...
All the Health Check procedures belonging to the same group defined a new kind of Health Check.
...
An `HealthCheck` implementation can have multiple `@HealthGroup` annotation to make it member of multiple custom Health Check's group.

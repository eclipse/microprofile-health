...
* A producer MAY support security on all check invocations (i.e. authentication)
* A producer MUST not enforce security by default, but it should be an opt-in configuration change
